...
@RoutePage(name: 'MicrophonePermissionScreenRoute')
class MicrophonePermissionScreen extends StatefulWidget {
  const MicrophonePermissionScreen({super.key, this.next, this.nextPage});
...
class _MicrophonePermissionScreenState
  ...
  void initState() {
    ...
    context.read<PermissionBloc>().add(
      PermissionEventCheckMicrophonePermission(),
    );
  }
  ...
  Future<void> _handlePermanentlyDenied() async {
    context.showConfirmationDialog(
      title: LocaleKeys
          .core_common_features_permission_presentation_screens_microphone_permission_screen_dialog_reAskTitle,
      message: LocaleKeys
          .core_common_features_permission_presentation_screens_microphone_permission_screen_dialog_reAskMessage,
  ...
  void _onContinuePressed() {
    context.read<PermissionBloc>().add(
      PermissionEventRequestMicrophonePermission(),
    );
  }

  void _onSkipPressed() {
    context.read<PermissionBloc>().add(
      PermissionEventSkipMicrophonePermission(),
    );
  }
    ...
    return BlocConsumer<PermissionBloc, PermissionState>(
      listenWhen: (previous, current) {
        ...
        final bool statusChanged =
            previous.microphonePermissionStatus !=
            current.microphonePermissionStatus;
        final bool skippedChanged =
            previous.skippedMicrophonePermissionGranted !=
            current.skippedMicrophonePermissionGranted;
      ...
      listener: (context, state) async {
        ...
        if (state.microphonePermissionStatus == PermissionStatus.granted ||
            state.skippedMicrophonePermissionGranted) {
        ...
        AppLogger.debug(
          ...
          '${state.microphonePermissionStatus}',
        );
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AppText(
                  LocaleKeys
                      .core_common_features_permission_presentation_screens_microphone_permission_screen_title,
                ...
                Padding(
                  ...
                  child: AppText(
                    LocaleKeys
                        .core_common_features_permission_presentation_screens_microphone_permission_screen_message,
