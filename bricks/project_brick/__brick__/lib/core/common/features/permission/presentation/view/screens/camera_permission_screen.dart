...
@RoutePage(name: 'CameraPermissionScreenRoute')
class CameraPermissionScreen extends StatefulWidget {
  const CameraPermissionScreen({super.key, this.next, this.nextPage});
...
class _CameraPermissionScreenState extends State<CameraPermissionScreen> {
  ...
  void initState() {
    super.initState();
    context.read<PermissionBloc>().add(PermissionEventCheckCameraPermission());
  }

  Future<void> _handlePermanentlyDenied() async {
    context.showConfirmationDialog(
      title: LocaleKeys
          .core_common_features_permission_presentation_screens_camera_permission_screen_dialog_reAskTitle,
      message: LocaleKeys
          .core_common_features_permission_presentation_screens_camera_permission_screen_dialog_reAskMessage,
  ...
  void _onContinuePressed() {
    context.read<PermissionBloc>().add(
      PermissionEventRequestCameraPermission(),
    );
  }

  void _onSkipPressed() {
    context.read<PermissionBloc>().add(PermissionEventSkipCameraPermission());
  }
    ...
    return BlocConsumer<PermissionBloc, PermissionState>(
      listenWhen: (previous, current) {
        ...
        final bool skippedChanged =
            previous.skippedCameraPermissionGranted !=
            current.skippedCameraPermissionGranted;
      ...
      listener: (context, state) async {
        ...
        if (state.cameraPermissionStatus == PermissionStatus.granted ||
            state.skippedCameraPermissionGranted) {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: AppText(
                    LocaleKeys
                        .core_common_features_permission_presentation_screens_camera_permission_screen_message,
