...
@RoutePage(name: 'LocationPermissionScreenRoute')
class LocationPermissionScreen extends StatefulWidget {
  const LocationPermissionScreen({super.key, this.next, this.nextPage});
...
class _LocationPermissionScreenState extends State<LocationPermissionScreen> {
  ...
  void initState() {
    ...
    context.read<PermissionBloc>().add(
      PermissionEventCheckLocationPermission(),
    );
  }
  ...
  Future<void> _handlePermanentlyDenied() async {
    context.showConfirmationDialog(
      title: LocaleKeys
          .core_common_features_permission_presentation_screens_location_permission_screen_dialog_reAskTitle,
      message: LocaleKeys
          .core_common_features_permission_presentation_screens_location_permission_screen_dialog_reAskMessage,
  ...
  void _onContinuePressed() {
    context.read<PermissionBloc>().add(
      PermissionEventRequestLocationPermission(),
    );
  }

  void _onSkipPressed() {
    context.read<PermissionBloc>().add(PermissionEventSkipLocationPermission());
  }
    ...
    return BlocConsumer<PermissionBloc, PermissionState>(
      listenWhen: (previous, current) {
        ...
        final bool skippedChanged =
            previous.skippedLocationPermissionGranted !=
            current.skippedLocationPermissionGranted;
      ...
      listener: (context, state) async {
        ...
        if (state.locationPermissionStatus == PermissionStatus.granted ||
            state.skippedLocationPermissionGranted) {
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AppText(
                  LocaleKeys
                      .core_common_features_permission_presentation_screens_location_permission_screen_title,
                ...
                Padding(
                  ...
                  child: AppText(
                    LocaleKeys
                        .core_common_features_permission_presentation_screens_location_permission_screen_message,
