...
@RoutePage(name: 'ActivityRecognitionPermissionScreenRoute')
class ActivityRecognitionPermissionScreen extends StatefulWidget {
  const ActivityRecognitionPermissionScreen({
    super.key,
    this.next,
    this.nextPage,
  });
  ...
  @override
  State<ActivityRecognitionPermissionScreen> createState() =>
      _ActivityRecognitionPermissionScreenState();

  final String? next;
  final PageRouteInfo? nextPage;
}

class _ActivityRecognitionPermissionScreenState
    extends State<ActivityRecognitionPermissionScreen> {
  @override
  void initState() {
    super.initState();
    context
        .read<PermissionBloc>()
        .add(PermissionEventCheckActivityRecognitionPermission());
  }

  Future<void> _handlePermanentlyDenied() async {
    context.showConfirmationDialog(
      title: LocaleKeys
          .core_common_features_permission_presentation_screens_activity_recognition_permission_screen_dialog_reAskTitle,
      message: LocaleKeys
          .core_common_features_permission_presentation_screens_activity_recognition_permission_screen_dialog_reAskMessage,
  ...
  void _onContinuePressed() {
    context
        .read<PermissionBloc>()
        .add(PermissionEventRequestActivityRecognitionPermission());
  }

  void _onSkipPressed() {
    context
        .read<PermissionBloc>()
        .add(PermissionEventSkipActivityRecognitionPermission());
  }
    ...
    return BlocConsumer<PermissionBloc, PermissionState>(
      listenWhen: (previous, current) {
        final bool statusChanged =
            previous.activityRecognitionPermissionStatus !=
            current.activityRecognitionPermissionStatus;
        final bool skippedChanged =
            previous.skippedActivityRecognitionPermissionGranted !=
            current.skippedActivityRecognitionPermissionGranted;
      ...
      listener: (context, state) async {
        ...
        if (state.activityRecognitionPermissionStatus ==
                PermissionStatus.granted ||
            state.skippedActivityRecognitionPermissionGranted) {
        ...
        AppLogger.debug(
          ...
          '${state.activityRecognitionPermissionStatus}',
        );
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AppText(
                  LocaleKeys
                      .core_common_features_permission_presentation_screens_activity_recognition_permission_screen_title,
                ...
                Padding(
                  ...
                  child: AppText(
                    LocaleKeys
                        .core_common_features_permission_presentation_screens_activity_recognition_permission_screen_message,
